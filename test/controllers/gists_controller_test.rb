...
class GistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gist" do
    assert_difference('Gist.count') do
      post gists_url, params: { gist: { code: @gist.code, description: @gist.description, filename: @gist.filename } }
    end
  ...
  test "should update gist" do
    patch gist_url(@gist), params: { gist: { code: @gist.code, description: @gist.description, filename: @gist.filename } }
